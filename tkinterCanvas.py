...
list1=['canada','USA','Brazil','Australia','UK','Germany','Turkey','India'];
c=StringVar()
...
label6=Label(root,text="Select One Programming Languages",width=30,font=("bold",10))
label6.place(x=85,y=330)
var1=IntVar()
Radiobutton(root,text="Python",variable=var1,value=1).place(x=235,y=350)
Radiobutton(root,text="Java",variable=var1,value=2).place(x=235,y=380)
Radiobutton(root,text="C++",variable=var1,value=3).place(x=235,y=420)
Radiobutton(root,text="PHP",variable=var1,value=4).place(x=235,y=480)
